...
ALGORITHMSHIGHER-ORDER FUNCTIONSFUNCTIONSCONTROL FLOWBASIC LANGUAGE FEATURESFUNDAMENTALSDATA STRUCTURESSTRINGSREGULAR EXPRESSIONSDECLARATIVE PROGRAMMINGADVANCED LANGUAGE FEATURES
...
function countDevelopers(list) {
  ...
  return list.reduce(function(acc,val) {
   return (val.continent.includes('Europe') && val.language.includes('JavaScript'))?acc+=1:acc},0)
